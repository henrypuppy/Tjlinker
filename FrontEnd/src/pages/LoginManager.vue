<template>
  <div class='page-container'>
    ...
    <div style='margin-bottom:60px;justify-content: center;align-items: center;'>
    ...
    />
      ...
      <img src='/Logos/Logo.png' style='width: 600px'
      alt='Logo'>
    ...
    <div class='button-container'>
      <ShadowButton width='221px' height='60px' style='margin-left: 50px'
         @click="handleLogin">
